...
const LOGIN_ERROR_MESSAGES: Record<string, string> = {
  ...
  // 招待リンク経由の失敗（/api/auth/line/callback から）。
  invite_notfound: "この招待リンクは存在しません。発行者にご確認ください。",
  invite_revoked: "この招待リンクは無効化されています。発行者にご確認ください。",
  invite_expired: "この招待リンクは期限切れです。発行者に再発行を依頼してください。",
  invite_used: "この招待リンクは使用済みです。発行者に再発行を依頼してください。",
  invite_disabled:
    "このアカウントは無効化されています。招待リンクでは復活できません。管理者にご確認ください。",
  invite_error: "招待の処理に失敗しました。もう一度お試しください。",
};
